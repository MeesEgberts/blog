...
* `@nestjs/cqrs` gives you `CommandBus`, `QueryBus`, `EventBus`, and helpers around aggregates and handlers. This is the backbone for CQRS in Nest. ([docs.nestjs.com][1])
